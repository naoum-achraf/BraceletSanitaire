      ...
      <div className="main__container ">
        ...
        <div className="main__title">
          ...
          <div className="main__greeting">
            ...
            <p>Welcome to Update des médecins</p>
          </div>
        </div>
        ...
        <div className="Form">
         ...
         <Form.Row> 
            ...
            <Form.Group as={Col} controlId="formGridCouleur"> 
                    ...
                    <Form.Control required value={this.state.hopitale} name="hopitale" type="text"  autoComplete="off" onChange={this.voitureChange}  placeholder= "Entrez hopitale"/>
            </Form.Group>
