...
submitPatient = event => { 
  ...
  const patient={
          ...
          respo:authService.getCurrentUser().id,
          role:["patient"]
  };      
 
axios.post("http://localhost:8080/api/auth/signup", patient)
      .then(response => {
      if (response.data != null) {
              this.setState({ show: true, method: "post" });
              this.setState(this.initialState);
              //window.location.href = '/crudPatient';
              window.location.href = '/addInfos/'+patient.email;
    ...
    <main>
      <div className="main__container ">
        ...
        <div className="Form">
            ...
            <Form onReset={this.resetVoiture} onSubmit={this.submitPatient} id="VoitureFormId"> 
