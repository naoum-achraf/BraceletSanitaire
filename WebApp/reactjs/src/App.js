...
import FormInfos from "./AgentComponents/GestionPatient/main/FormInfos";
import UpdatePatient from "./AgentComponents/UpdatePatient/main/Main";
import Suivre from "./AgentComponents/Progress/main/Main";
import Graph from "./AgentComponents/Progress/main/canvasjs.react";
...
class App extends Component {
  ...
  componentDidMount() {
    ...
    if (user) {
      this.setState({
        currentUser: user,
        showModeratorBoard: user.roles.includes("ROLE_MEDECIN"),
      ...
      <div>
        ...
        <div className="container1">
          <Switch>
            ...
            <ProtectedAgent path="/FormInfos" component={FormInfos} />
            ...
            <ProtectedAgent path="/graph" component={Graph} />
